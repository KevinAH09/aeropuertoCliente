...
public class AvionesService {
    public static List<AvionesDTO> allAviones(){
        ...
        try {
            listsDTOs = (List<AvionesDTO>) Conection.listFromConnection("AreaTrabajo/",AvionesDTO.class);
    ...
    public static AvionesDTO idAvion(Long id){
        ...
        try {
            dTO = (AvionesDTO) Conection.oneConnection("AreaTrabajo/"+id,new TypeToken<AvionesDTO>() {}.getType());
    ...
    public static int updateAvion(AvionesDTO create){
        int codeResponse=0;
        try {
            codeResponse = Conection.updateObjectToConnection("AreaTrabajo/"+create.getId(),AvionesDTO.class);
        } catch (IOException ex) {
            Logger.getLogger(LoginService.class.getName()).log(Level.SEVERE, null, ex);
        }
        return codeResponse;
